...
class joints2smpl:
    ...
    def npy2smpl(self, npy_path):
        ...
        for sample_i in tqdm(range(n_samples)):
            ...
            thetas, _ = self.joint2smpl(motions[sample_i].transpose(2, 0, 1))  # [nframes, njoints, 3]
...
if __name__ == '__main__':
    ...
    simplify = joints2smpl(num_frames=48, device_id=params.device, cuda=params.cuda)
